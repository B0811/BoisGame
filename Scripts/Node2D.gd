	...
	if type == "enemyboot":
		...
		if mob_spawn_rounds >= 1:
			for i in mob_spawn_rounds:
				...
				enemyboot1.global_position = boot_spawn2.global_position
				var enemyboot3 = enemyboot_scene.instantiate()
				enemyboot1.global_position = boot_spawn3.global_position
				var enemyboot4 = enemyboot_scene.instantiate()
				enemyboot1.global_position = boot_spawn4.global_position
				var enemyboot5 = enemyboot_scene.instantiate()
				enemyboot1.global_position = boot_spawn5.global_position
